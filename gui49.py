...
b1=Button(text="9",font=("",25),bg="gray",fg="white",activebackground="yellow"
          ,activeforeground="red")
b1.place(x=5,y=55,width=100,height=50)
b1.configure(command = lambda:show("9"))
...
b3=Button(text="7",font=("",25),bg="gray",fg="white",activebackground="yellow"
          ,activeforeground="red")
b3.place(x=215,y=55,width=100,height=50)
b3.configure(command=lambda:show("7"))
...
b5=Button(text="6",font=("",25),bg="gray",fg="white",activebackground="yellow"
          ,activeforeground="red")
...
b7=Button(text="4",font=("",25),bg="gray",fg="white",activebackground="yellow"
          ,activeforeground="red")
...
b9=Button(text="3",font=("",25),bg="gray",fg="white",activebackground="yellow"
          ,activeforeground="red")
...
b11=Button(text="1",font=("",25),bg="gray",fg="white",activebackground="yellow"
          ,activeforeground="red")
...
b15=Button(text="=",font=("",25),bg="gray",fg="white",activebackground="yellow"
          ,activeforeground="red")
b15.place(x=215,y=220,width=100,height=50)
b15.configure(command=eqe)
